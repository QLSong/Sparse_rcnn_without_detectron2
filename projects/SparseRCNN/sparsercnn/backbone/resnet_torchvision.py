...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, input_shape, num_classes=1000, zero_init_residual=False,
...
def _resnet(arch, block, layers, pretrained, input_shape, progress, **kwargs):
    model = ResNet(block, layers, input_shape, **kwargs)
    if pretrained:
...
def resnet18(pretrained=False, progress=True, input_shape=None, **kwargs):
    ...
    """
    return _resnet('resnet18', BasicBlock, [2, 2, 2, 2], pretrained, input_shape, progress,
                   **kwargs)
